...
\renewcommand{\thetitle}{Think Stats}
...
% Override the \title for the web page.
\HTMLTitle{Think Stats: Exploratory Data Analysis in Python}

% Sets the HTML meta author tag.
\HTMLAuthor{Allen B. Downey}

% Sets the HTML meta language.
\HTMLLanguage{en-US}
...
\HTMLFirstPageTop{
\textscale{1.44}{Green Tea Press}\\
Free books by Allen B. Downey
}
...
\CSSFilename{book.css}

\MathJaxFilename{book_mathjax.html}
...
% This must come before loading 'latexonly'
...
\begin{titlepage}
\textscale{1.44}{\thetitle: \thesubtitle}

\textscale{1.2}{Allen B. Downey}{}
...
\cleardoublepage
\phantomsection
\addcontentsline{toc}{section}{\indexname}% or chapter
\end{warpprint}
\ForceHTMLPage
\ForceHTMLTOC
\printindex
