...
// We define an "empty" attribute "_" so we can provide visual separation between
...
// For HTML, we include the advert sidbar as an unnumbered discrete section
ifdef::backend-html5[]
...
// This counter is a hack to get Exercise and numbering to work how we want.  A proper
// fix for this is being worked on upstream.
{counter2:chapter}
:exercise!:
...
*Exercise {chapter}.{counter:exercise}*
